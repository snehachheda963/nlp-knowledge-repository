...
## Challenges Faced
The hardest part was explaining vector similarity in plain language without leaning on heavy math, since concepts like cosine distance are easy to compute but harder to describe intuitively. Finding examples that weren't just generic textbook pairs like "king/queen" also took a few tries — I wanted something that would actually connect to the banking/financial grievance angle the rest of the repo leans into.
